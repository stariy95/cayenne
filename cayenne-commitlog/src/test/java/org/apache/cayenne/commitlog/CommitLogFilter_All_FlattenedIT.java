	...
	public void testPostCommit_UpdateToMany() throws SQLException {
		...
		doAnswer(new Answer<Object>() {
			...
			public Object answer(InvocationOnMock invocation) throws Throwable {
				...
				ObjectChange e3c = changes.getChanges().get(objectId("E3", E3.ID_PK_COLUMN, 1));
				assertNotNull(e3c);
				...
				ObjectChange e41c = changes.getChanges().get(objectId("E4", E4.ID_PK_COLUMN, 11));
				assertNotNull(e41c);
				...
				ObjectChange e42c = changes.getChanges().get(objectId("E4", E4.ID_PK_COLUMN, 12));
				assertNotNull(e42c);
