 ...
 * @since 4.1
 */
public class BaseSQLTreeProcessor implements Function<Node, Node> {

    @Override
    public Node apply(Node node) {
        NodeTreeVisitor visitor = new ReplacerTreeVisitor();
        node.visit(visitor);
        return node;
    }
...
//    protected void onEqualNode(Node parent, EqualNode child, int index) {
//    }
    ...
    private class ReplacerTreeVisitor implements NodeTreeVisitor {
...
//                case EQUALITY:
//                    onEqualNode(parent, (EqualNode)child, index);
//                    break;
